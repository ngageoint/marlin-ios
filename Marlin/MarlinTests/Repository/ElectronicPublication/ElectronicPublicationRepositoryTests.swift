//
//  ElectronicPublicationRepositoryTests.swift
//  MarlinTests
//
...
final class ElectronicPublicationRepositoryTests: XCTestCase {
    ...
    func testFetch() async {
        var models: [ElectronicPublicationModel] = []
        ...
        let decoded: [ElectronicPublicationModel] = try! JSONDecoder().decode([ElectronicPublicationModel].self, from: jsonData)
        ...
        let localDataSource = ElectronicPublicationStaticLocalDataSource()
        let remoteDataSource = ElectronicPublicationStaticRemoteDataSource()
        remoteDataSource.list = models
        let repository = ElectronicPublicationRepository(localDataSource: localDataSource, remoteDataSource: remoteDataSource)
        ...
        let repoEpub = repository.getElectronicPublication(s3Key: "16693989/SFH00000/108dec.pdf")
        XCTAssertNotNil(repoEpub)
        XCTAssertEqual(repoEpub, localDataSource.getElectronicPublication(s3Key: "16693989/SFH00000/108dec.pdf"))
