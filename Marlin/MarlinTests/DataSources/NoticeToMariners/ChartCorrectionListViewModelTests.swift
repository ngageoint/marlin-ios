...
final class ChartCorrectionListViewModelTests: XCTestCase {
    ...
    func testNoticeNumberEquals() {
        ...
        let model = ChartCorrectionListViewModel()
        XCTAssertEqual(model.createQueryParameters()?.sorted(), ["output=json", "noticeNumber=202104", "latitudeLeft=1.9833732516151774", "latitudeRight=2.0166265798958696", "longitudeLeft=3.0166367990618945", "longitudeRight=2.9833632009381055"].sorted())
    }
    ...
    func testNoticeNumberLessThan() {
        ...
        let model = ChartCorrectionListViewModel()
        XCTAssertEqual(model.createQueryParameters()?.sorted(), ["output=json", "maxNoticeNumber=202052", "minNoticeNumber=199929", "latitudeLeft=1.9833732516151774", "latitudeRight=2.0166265798958696", "longitudeLeft=3.0166367990618945", "longitudeRight=2.9833632009381055"].sorted())
    }
    ...
    func testNoticeNumberLessThanEqual() {
        ...
        let model = ChartCorrectionListViewModel()
        XCTAssertEqual(model.createQueryParameters()?.sorted(), ["output=json", "maxNoticeNumber=202101", "minNoticeNumber=199929", "latitudeLeft=1.9833732516151774", "latitudeRight=2.0166265798958696", "longitudeLeft=3.0166367990618945", "longitudeRight=2.9833632009381055"].sorted())
    }
    ...
    func testNoticeNumberGreaterThan() {
        ...
        XCTAssertEqual(model.createQueryParameters()?.sorted(), ["output=json", "maxNoticeNumber=\(thisYear)\(String(format: "%02d", thisWeek))", "minNoticeNumber=202101", "latitudeLeft=1.9833732516151774", "latitudeRight=2.0166265798958696", "longitudeLeft=3.0166367990618945", "longitudeRight=2.9833632009381055"].sorted())
    }
    ...
    func testNoticeNumberGreaterThanEqual() {
        ...
        let thisWeek = calendar.component(.weekOfYear, from: Date())
        let thisYear = calendar.component(.year, from: Date())
        XCTAssertEqual(model.createQueryParameters()?.sorted(), ["output=json", "maxNoticeNumber=\(thisYear)\(String(format: "%02d", thisWeek))", "minNoticeNumber=202052", "latitudeLeft=1.9833732516151774", "latitudeRight=2.0166265798958696", "longitudeLeft=3.0166367990618945", "longitudeRight=2.9833632009381055"].sorted())
    }
    ...
    func testLocationCloseTo() {
        ...
        XCTAssertEqual(model.createQueryParameters()?.sorted(), ["output=json", "latitudeLeft=1.9833732516151774", "latitudeRight=2.0166265798958696", "longitudeLeft=3.0166367990618945", "longitudeRight=2.9833632009381055"].sorted())
    }
