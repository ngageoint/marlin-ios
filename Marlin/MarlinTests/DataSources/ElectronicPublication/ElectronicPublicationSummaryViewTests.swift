...
final class ElectronicPublicationSummaryViewTests: XCTestCase {
    ...
    func testNotDownloaded() {
        ...
        let remoteDataSource = ElectronicPublicationRemoteDataSource()
        ...
        let summary = ElectronicPublicationSummaryView(s3Key: epub.s3Key ?? "")
    ...
    func testDownload() {
        ...
        let progressExpectation = expectation(for: repository.getElectronicPublication(s3Key: epub.s3Key)?.downloadProgress == 1.0)
