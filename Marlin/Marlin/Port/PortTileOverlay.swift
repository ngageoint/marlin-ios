            ...
            if let objects = objects {
                for object in objects {
                    ...
                    for mapImage in mapImages {
                        ...
                        let xPosition = (((object3857Location.x - minTileX) / (maxTileX - minTileX)) * self.tileSize.width)
                        let yPosition = self.tileSize.height - (((object3857Location.y - minTileY) / (maxTileY - minTileY)) * self.tileSize.height)
