...
struct SnackbarModel {
    ...
    init(message: String?, actionText: String?, action: (() -> Void)?) {
...
struct Snackbar<Presenting, Content>: View where Presenting: View, Content: View {
