...
protocol TestViewProtocol: View {
...
extension View where Self: TestViewProtocol {
    func setShowMoreDetails2(_ showMoreDetails: Bool) -> some TestViewProtocol {
        var newView = self
        newView.showBookmarkNotes = showMoreDetails
        return newView
    }
    func setShowTitle2(_ showTitle: Bool) -> some TestViewProtocol {
        var newView = self
        newView.showTitle = showTitle
        return newView
    }
    func setShowSectionHeader2(_ showSectionHeader: Bool) -> some TestViewProtocol {
        var newView = self
        newView.showSectionHeader = showSectionHeader
        return newView
    }
    func showBookmarkNotes2(_ showBookmarkNotes: Bool) -> some TestViewProtocol {
        var newView = self
    ...
    @ViewBuilder
    func bookmarkNotesView2(bookmarkViewModel: TestModel?) -> some View {
...
struct TestView: View {
    @StateObject var viewModel: TestModel = TestModel()
...
struct NWModel: Codable, Hashable, Identifiable, Bookmarkable, GeoJSONExportable, Locatable {
